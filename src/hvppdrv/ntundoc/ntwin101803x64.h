#pragma once
#include <ntifs.h>
#ifndef NTWIN101803X64_H
#define NTWIN101803X64_H
namespace ntwin101803x64 {
  ...
  typedef struct _EPROCESS                                               // 220 elements, 0x848 bytes (sizeof) 
  {
  ...
  typedef struct _ETHREAD                                            // 113 elements, 0x818 bytes (sizeof) 
  {
