#pragma once
#include <ntifs.h>
#ifndef NTWIN101709X64_H
#define NTWIN101709X64_H
namespace ntwin101709x64 {
  ...
  typedef struct _MMSUPPORT_INSTANCE               // 21 elements, 0xC8 bytes (sizeof) 
  {
    ...
    /*0x0C0*/     struct _MMSUPPORT_FLAGS Flags;               // 17 elements, 0x4 bytes (sizeof)  
  ...
  typedef struct _KPROCESS                          // 44 elements, 0x2D8 bytes (sizeof) 
  {
    /*0x000*/     struct _DISPATCHER_HEADER Header;             // 57 elements, 0x18 bytes (sizeof)  
    ...
    union                                         // 2 elements, 0x4 bytes (sizeof)    
    {
      struct                                    // 10 elements, 0x4 bytes (sizeof)   
      {
        ...
        /*0x1B8*/             ULONG32      PpmPolicy : 3;           // 6 BitPosition                     
        /*0x1B8*/             ULONG32      ActiveGroupsMask : 20;   // 9 BitPosition                     
        /*0x1B8*/             ULONG32      VaSpaceDeleted : 1;      // 29 BitPosition                    
        /*0x1B8*/             ULONG32      ReservedFlags : 2;       // 30 BitPosition                    
      };
  ...
  typedef struct _EPROCESS                                               // 215 elements, 0x840 bytes (sizeof) 
  {
    /*0x000*/     struct _KPROCESS Pcb;                                              // 44 elements, 0x2D8 bytes (sizeof)  
    ...
    {
      /*0x6CB*/         UINT8        HangCount : 4;                                    // 0 BitPosition                      
      /*0x6CB*/         UINT8        GhostCount : 4;                                   // 4 BitPosition                      
    };
    union                                                              // 2 elements, 0x4 bytes (sizeof)     
    {
    ...
    /*0x720*/     VOID* EnclaveTable;
    /*0x728*/     UINT64       EnclaveNumber;
    /*0x730*/     struct _EX_PUSH_LOCK EnclaveLock;                                  // 7 elements, 0x8 bytes (sizeof)     
    /*0x738*/     ULONG32      HighPriorityFaultsAllowed;
    /*0x73C*/     UINT8        _PADDING2_[0x4];
    /*0x740*/     struct _PO_PROCESS_ENERGY_CONTEXT* EnergyContext;
    /*0x748*/     VOID* VmContext;
    /*0x750*/     UINT64       SequenceNumber;
    /*0x758*/     UINT64       CreateInterruptTime;
    /*0x760*/     UINT64       CreateUnbiasedInterruptTime;
    /*0x768*/     UINT64       TotalUnbiasedFrozenTime;
    /*0x770*/     UINT64       LastAppStateUpdateTime;
    struct                                                             // 2 elements, 0x8 bytes (sizeof)     
    {
      /*0x778*/         UINT64       LastAppStateUptime : 61;                          // 0 BitPosition                      
      /*0x778*/         UINT64       LastAppState : 3;                                 // 61 BitPosition                     
    };
    /*0x780*/     UINT64       SharedCommitCharge;
    /*0x788*/     struct _EX_PUSH_LOCK SharedCommitLock;                             // 7 elements, 0x8 bytes (sizeof)     
    /*0x790*/     struct _LIST_ENTRY SharedCommitLinks;                              // 2 elements, 0x10 bytes (sizeof)    
    union                                                              // 2 elements, 0x10 bytes (sizeof)    
    {
      struct                                                         // 2 elements, 0x10 bytes (sizeof)    
      {
        /*0x7A0*/             UINT64       AllowedCpuSets;
        /*0x7A8*/             UINT64       DefaultCpuSets;
      };
      struct                                                         // 2 elements, 0x10 bytes (sizeof)    
      {
        /*0x7A0*/             UINT64* AllowedCpuSetsIndirect;
        /*0x7A8*/             UINT64* DefaultCpuSetsIndirect;
      };
    };
    /*0x7B0*/     VOID* DiskIoAttribution;
    /*0x7B8*/     VOID* DxgProcess;
    /*0x7C0*/     ULONG32      Win32KFilterSet;
    /*0x7C4*/     UINT8        _PADDING3_[0x4];
    /*0x7C8*/     union _PS_INTERLOCKED_TIMER_DELAY_VALUES ProcessTimerDelay;        // 7 elements, 0x8 bytes (sizeof)     
    /*0x7D0*/     ULONG32      KTimerSets;
    /*0x7D4*/     ULONG32      KTimer2Sets;
    /*0x7D8*/     ULONG32      ThreadTimerSets;
    /*0x7DC*/     UINT8        _PADDING4_[0x4];
    /*0x7E0*/     UINT64       VirtualTimerListLock;
    /*0x7E8*/     struct _LIST_ENTRY VirtualTimerListHead;                           // 2 elements, 0x10 bytes (sizeof)    
    union                                                              // 2 elements, 0x30 bytes (sizeof)    
    {
      /*0x7F8*/         struct _WNF_STATE_NAME WakeChannel;                            // 1 elements, 0x8 bytes (sizeof)     
      /*0x7F8*/         struct _PS_PROCESS_WAKE_INFORMATION WakeInfo;                  // 4 elements, 0x30 bytes (sizeof)    
    };
    union                                                              // 2 elements, 0x4 bytes (sizeof)     
    {
      /*0x828*/         ULONG32      MitigationFlags;
      struct                                                         // 31 elements, 0x4 bytes (sizeof)    
      {
        /*0x828*/             ULONG32      ControlFlowGuardEnabled : 1;                  // 0 BitPosition                      
        /*0x828*/             ULONG32      ControlFlowGuardExportSuppressionEnabled : 1; // 1 BitPosition                      
        /*0x828*/             ULONG32      ControlFlowGuardStrict : 1;                   // 2 BitPosition                      
        /*0x828*/             ULONG32      DisallowStrippedImages : 1;                   // 3 BitPosition                      
        /*0x828*/             ULONG32      ForceRelocateImages : 1;                      // 4 BitPosition                      
        /*0x828*/             ULONG32      HighEntropyASLREnabled : 1;                   // 5 BitPosition                      
        /*0x828*/             ULONG32      StackRandomizationDisabled : 1;               // 6 BitPosition                      
        /*0x828*/             ULONG32      ExtensionPointDisable : 1;                    // 7 BitPosition                      
        /*0x828*/             ULONG32      DisableDynamicCode : 1;                       // 8 BitPosition                      
        /*0x828*/             ULONG32      DisableDynamicCodeAllowOptOut : 1;            // 9 BitPosition                      
        /*0x828*/             ULONG32      DisableDynamicCodeAllowRemoteDowngrade : 1;   // 10 BitPosition                     
        /*0x828*/             ULONG32      AuditDisableDynamicCode : 1;                  // 11 BitPosition                     
        /*0x828*/             ULONG32      DisallowWin32kSystemCalls : 1;                // 12 BitPosition                     
        /*0x828*/             ULONG32      AuditDisallowWin32kSystemCalls : 1;           // 13 BitPosition                     
        /*0x828*/             ULONG32      EnableFilteredWin32kAPIs : 1;                 // 14 BitPosition                     
        /*0x828*/             ULONG32      AuditFilteredWin32kAPIs : 1;                  // 15 BitPosition                     
        /*0x828*/             ULONG32      DisableNonSystemFonts : 1;                    // 16 BitPosition                     
        /*0x828*/             ULONG32      AuditNonSystemFontLoading : 1;                // 17 BitPosition                     
        /*0x828*/             ULONG32      PreferSystem32Images : 1;                     // 18 BitPosition                     
        /*0x828*/             ULONG32      ProhibitRemoteImageMap : 1;                   // 19 BitPosition                     
        /*0x828*/             ULONG32      AuditProhibitRemoteImageMap : 1;              // 20 BitPosition                     
        /*0x828*/             ULONG32      ProhibitLowILImageMap : 1;                    // 21 BitPosition                     
        /*0x828*/             ULONG32      AuditProhibitLowILImageMap : 1;               // 22 BitPosition                     
        /*0x828*/             ULONG32      SignatureMitigationOptIn : 1;                 // 23 BitPosition                     
        /*0x828*/             ULONG32      AuditBlockNonMicrosoftBinaries : 1;           // 24 BitPosition                     
        /*0x828*/             ULONG32      AuditBlockNonMicrosoftBinariesAllowStore : 1; // 25 BitPosition                     
        /*0x828*/             ULONG32      LoaderIntegrityContinuityEnabled : 1;         // 26 BitPosition                     
        /*0x828*/             ULONG32      AuditLoaderIntegrityContinuity : 1;           // 27 BitPosition                     
        /*0x828*/             ULONG32      EnableModuleTamperingProtection : 1;          // 28 BitPosition                     
        /*0x828*/             ULONG32      EnableModuleTamperingProtectionNoInherit : 1; // 29 BitPosition                     
        /*0x828*/             ULONG32      RestrictIndirectBranchPrediction : 1;         // 30 BitPosition                     
      }MitigationFlagsValues;
    };
    union                                                              // 2 elements, 0x4 bytes (sizeof)     
    {
      /*0x82C*/         ULONG32      MitigationFlags2;
      struct                                                         // 14 elements, 0x4 bytes (sizeof)    
      {
        /*0x82C*/             ULONG32      EnableExportAddressFilter : 1;                // 0 BitPosition                      
        /*0x82C*/             ULONG32      AuditExportAddressFilter : 1;                 // 1 BitPosition                      
        /*0x82C*/             ULONG32      EnableExportAddressFilterPlus : 1;            // 2 BitPosition                      
        /*0x82C*/             ULONG32      AuditExportAddressFilterPlus : 1;             // 3 BitPosition                      
        /*0x82C*/             ULONG32      EnableRopStackPivot : 1;                      // 4 BitPosition                      
        /*0x82C*/             ULONG32      AuditRopStackPivot : 1;                       // 5 BitPosition                      
        /*0x82C*/             ULONG32      EnableRopCallerCheck : 1;                     // 6 BitPosition                      
        /*0x82C*/             ULONG32      AuditRopCallerCheck : 1;                      // 7 BitPosition                      
        /*0x82C*/             ULONG32      EnableRopSimExec : 1;                         // 8 BitPosition                      
        /*0x82C*/             ULONG32      AuditRopSimExec : 1;                          // 9 BitPosition                      
        /*0x82C*/             ULONG32      EnableImportAddressFilter : 1;                // 10 BitPosition                     
        /*0x82C*/             ULONG32      AuditImportAddressFilter : 1;                 // 11 BitPosition                     
        /*0x82C*/             ULONG32      DisablePageCombine : 1;                       // 12 BitPosition                     
        /*0x82C*/             ULONG32      SpeculativeStoreBypassDisable : 1;            // 13 BitPosition                     
      }MitigationFlags2Values;
    };
    /*0x830*/     VOID* PartitionObject;
    /*0x838*/     UINT64       SecurityDomain;
  }EPROCESS, * PEPROCESS;
  ...
  typedef struct _KTHREAD                                            // 184 elements, 0x5F0 bytes (sizeof) 
  {
    /*0x000*/     struct _DISPATCHER_HEADER Header;                              // 57 elements, 0x18 bytes (sizeof)   
  ...
  typedef struct _ETHREAD                                            // 112 elements, 0x818 bytes (sizeof) 
  {
    /*0x000*/     struct _KTHREAD Tcb;                                           // 184 elements, 0x5F0 bytes (sizeof) 
    ...
    union                                                          // 2 elements, 0x4 bytes (sizeof)     
    {
      ...
      struct                                                     // 20 elements, 0x4 bytes (sizeof)    
      {
        ...
        /*0x6D0*/             ULONG32      ReservedCrossThreadFlags : 9;             // 23 BitPosition                     
      };
    };
    union                                                          // 2 elements, 0x4 bytes (sizeof)     
    {
      ...
      struct                                                     // 11 elements, 0x4 bytes (sizeof)    
      {
        ...
        /*0x6D4*/             ULONG32      ReservedSameThreadPassiveFlags : 21;      // 11 BitPosition                     
      };
    };
    union                                                          // 2 elements, 0x4 bytes (sizeof)     
    {
    ...
    /*0x770*/     ULONG32      KernelStackReference;
    /*0x774*/     UINT8        _PADDING1_[0x4];
    /*0x778*/     VOID* AdjustedClientToken;
    /*0x780*/     VOID* WorkOnBehalfThread;
    /*0x788*/     struct _PS_PROPERTY_SET PropertySet;                           // 2 elements, 0x18 bytes (sizeof)    
    /*0x7A0*/     VOID* PicoContext;
    /*0x7A8*/     UINT64       UserFsBase;
    /*0x7B0*/     UINT64       UserGsBase;
    /*0x7B8*/     struct _THREAD_ENERGY_VALUES* EnergyValues;
    /*0x7C0*/     VOID* CmDbgInfo;
    union                                                          // 2 elements, 0x8 bytes (sizeof)     
    {
      /*0x7C8*/         UINT64       SelectedCpuSets;
      /*0x7C8*/         UINT64* SelectedCpuSetsIndirect;
    };
    /*0x7D0*/     struct _EJOB* Silo;
    /*0x7D8*/     struct _UNICODE_STRING* ThreadName;
    /*0x7E0*/     struct _CONTEXT* SetContextState;
    /*0x7E8*/     ULONG32      LastExpectedRunTime;
    /*0x7EC*/     UINT8        _PADDING2_[0x4];
    /*0x7F0*/     struct _LIST_ENTRY OwnerEntryListHead;                         // 2 elements, 0x10 bytes (sizeof)    
    /*0x800*/     UINT64       DisownedOwnerEntryListLock;
    /*0x808*/     struct _LIST_ENTRY DisownedOwnerEntryListHead;                 // 2 elements, 0x10 bytes (sizeof)    
  }ETHREAD, * PETHREAD;
