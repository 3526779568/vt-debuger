...
///////////////////////////////////////////////////////////////////////////////
	...
	namespace eastl
	{
		...
		/// 
		EASTL_API static EASTL_AssertionFailureFunction gpAssertionFailureFunction = AssertionFailureFunctionDefault;
		EASTL_API static  void*  gpAssertionFailureFunctionContext = NULL;
		...
		///
		EASTL_API inline void SetAssertionFailureFunction(EASTL_AssertionFailureFunction pAssertionFailureFunction, void* pContext)
		{
		...
		///
		EASTL_API inline void AssertionFailureFunctionDefault(const char* pExpression, void* /*pContext*/)
		{
#if EASTL_ASSERT_ENABLED
		...
		/// AssertionFailure
		///
		EASTL_API inline void AssertionFailure(const char* pExpression)
		{
